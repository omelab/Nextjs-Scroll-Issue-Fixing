      ...
      <div className="flex items-center min-h-96 bg-sky-600 p-20">
        <div>
          ...
          <p>
            ...
            prefers-reduced-motion, and more. For example, use md:items-center
            to apply the items-center utility at only medium screen sizes and
            above.
          </p>
          <p>
